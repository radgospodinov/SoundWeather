...
<body id="register_space">
	...
	<div id="form">
		<input id="username" type="text" name="username"
			placeholder="choose username" required /> <br /> <input id="pass1"
			type="password" name="password1" placeholder="choose password"
			...
			required /> <br /> <input id="email" type="text" name="email"
			placeholder="enter emaild" onkeyup="validateEmail(); return false;"
			required /> <br /> <input id="location" type="text" name="location"
		...
		</select> <br /> <input type="submit" value="Register" onclick="register()" />
		<br />
	</div>
